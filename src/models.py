...
from torch.nn import Linear, BatchNorm1d, Embedding, ModuleList,LayerNorm,Dropout
...
class Hyper_classification(torch.nn.Module):
    def __init__(self, label_size, vocabulary_size, edge_arity_dict, embedding_size, num_gnn_layers,
        ...
        for i in range(num_gnn_layers):
            hyper_conv_list.append(HyperConv(embedding_size, embedding_size, edge_arity_dict=edge_arity_dict))
