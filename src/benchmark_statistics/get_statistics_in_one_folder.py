...
def main():
    folder="/home/cheli243/PycharmProjects/HintsLearning/benchmarks/Template-selection-Liner-dateset-new/splitClauses-1/solvability-splitClauses-1/train_data_separate_summary/UNKNOWN+UNSAT"
